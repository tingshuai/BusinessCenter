...
<departTree ref="roleTree" :config="treeConfigDepart" @nodeLabelClicked="nodeLabelClickedDepart"></departTree>
<modelTreeFix ref="modelTree" :config="treeConfig" @nodeLabelClicked="nodeLabelClicked" style="margin-left:-368px;" :style="{marginTop:((sidebarHeight) * 0.6)-40 + 'px'}"></modelTreeFix>
<div class="rbox" style="{minHeight:sidebarHeight-136+'px'}">
    ...
    <qwDialog ref="DialogAuthSetting" :config="DialogAuthSetting">
        <dialogAuthSettingBody ref="DialogAuthSettingBody" @close="closeDialogAuthSetting"></dialogAuthSettingBody>
    </qwDialog>
</div>
</div>
</template>
...
import dialogAuthSettingBody from "./dialogAuthSettingBody.vue"
// import ruleDialogBody from "../dataAuthMehod/ruleDialogBody.vue"
// import authDialogBody from "../dataAuthMehod/authDialogBody.vue"
...
export default {
    ...
    methods:{
        nodeLabelClickedDepart(node){
            this.curRoleNode = node;
            // console.log("nodeLabelClickedDepart")
        },
        /*tree label 点击事件回调*/
        ...
        closeDialogAuthSetting(data){
            this.$refs.DialogAuthSettingBody.reset();
            setTimeout(() => {
                this.DialogAuthSetting.dialogVisible = false;    
            }, 30);
        },
