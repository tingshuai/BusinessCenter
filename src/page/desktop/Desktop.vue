...
<div class="desktop_root">
	<!-- :config="form1"  -->
	<!-- <div style="width:800px;"><qwform @formBtnClicked="formBtnClicked"></qwform></div> -->
	
	 <!-- <div style="width:800px;">
		 <qwfromtable></qwfromtable>
	 </div> -->
    <qwModalForm ref="qwModalForm" :config="config"></qwModalForm>
                            ...
                            
                                {
                                    ...
                                    remoteMethod(query){
                                        console.log(this.rightMenu);
                                         let conf=this.$attrs.config;//动态绑定到了config上面
